...
function App() {
    ...
    return (
        <div className="min-h-screen bg-darker text-slate-100 pb-20 overflow-x-hidden">
            <Header />

            <main className="max-w-4xl lg:max-w-[70rem] mx-auto px-4 sm:px-6 mt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                        ...
                        <div className="md:col-span-3">
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-accent-teal to-accent-blue hover:from-teal-400 hover:to-blue-500 text-white font-bold rounded-2xl px-5 py-4 transition-all hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2 shadow-[0_10px_20px_-10px_rgba(20,184,166,0.5)] group overflow-hidden relative"
                            >
                ...
                {!result && (
                    <div className="flex flex-col items-center justify-center p-12 text-center animate-in fade-in zoom-in duration-700">
                        <div className="w-24 h-24 mb-6 rounded-3xl bg-slate-800/50 flex items-center justify-center border border-slate-700/50 shadow-[0_0_50px_rgba(20,184,166,0.1)] group">
                            <Target className="w-12 h-12 text-slate-500 group-hover:text-accent-teal transition-colors duration-500 animate-pulse-slow" />
                        </div>
                ...
                {result && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <div className="glass-panel p-8 rounded-3xl mt-8 relative" style={{ animation: `fadeInUp 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.5s both` }}>
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[80%] bg-accent-teal/5 blur-[80px] rounded-full pointer-events-none"></div>

                            <h3 className="text-2xl font-black mb-1 tracking-tight text-white flex items-center gap-2">
                                <Activity className="w-6 h-6 text-accent-teal" /> Impact Trend {result2 && 'Comparison'}
                            </h3>
