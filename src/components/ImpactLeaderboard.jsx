...
export function ImpactLeaderboard() {
    ...
    return (
        <div className="bg-slate-900/40 backdrop-blur-md rounded-[2rem] overflow-hidden mb-10 border border-white/5 relative">
                    ...
                    >
                        <div className="flex items-center gap-6">
                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-black text-sm border ${
                                index === 0 ? 'bg-amber-400/20 border-amber-400/30 text-amber-400' :
